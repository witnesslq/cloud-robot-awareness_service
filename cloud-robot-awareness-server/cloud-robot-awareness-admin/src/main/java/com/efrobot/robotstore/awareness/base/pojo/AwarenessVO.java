...
public class AwarenessVO implements java.io.Serializable {
	...
	// 意识业务逻辑URL
	private String awareness_business_url;

	public String getAwareness_business_url() {
		return awareness_business_url;
	}

	public void setAwareness_business_url(String awareness_business_url) {
		this.awareness_business_url = awareness_business_url;
	}
